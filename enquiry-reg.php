<?php
    ...
    $q="insert into enquiry(DATE,NAME,FATHERNAME,MOTHERNAME,MOBILE,ADDRESS,COURSE,DATEOFBIRTH) values('$DATE','$NAME','$FATHERNAME','$MOTHERNAME','$MOBILE','$ADDRESS','$COURSE','$DATEOFBIRTH')";
    ...
    <br>
     ...
     <?php 
        ...
        <div style="text-align:center;">
            ...
            <a href="../Vista/enquiry.html"><button type="button" class="btn btn-primary"><h5> Register More </h5></button></a>        
        </div>
