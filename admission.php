<?php
    ...
    $q="insert into admission(DATE,NAME,FATHERNAME,MOTHERNAME,DATEOFBIRTH,GENDER,MOBILE,ADDRESS,CITY,STATE,NATIONALITY,COURSE,QUALIFICATION,TIME) values('$DATE','$NAME','$FATHERNAME','$MOTHERNAME','$DATEOFBIRTH','$GENDER','$MOBILE','$ADDRESS','$CITY','$STATE','$NATIONALITY','$COURSE','$QUALIFICATION','$TIME')";
    ...
    <br>
     ...
     <?php 
        ...
        <div style="text-align:center;">
            ...
            <a href="../Vista/Admission.html"><button type="button" class="btn btn-primary"><h5> Register More </h5></button></a>        
        </div>
